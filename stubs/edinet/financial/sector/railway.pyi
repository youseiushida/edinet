...
__all__ = ['RAILWAY_INDUSTRY_CODES', 'all_mappings', 'all_sector_keys', 'from_general_key', 'get_profile', 'is_railway_industry', 'lookup', 'registry', 'reverse_lookup', 'sector_key', 'to_general_key']

RAILWAY_INDUSTRY_CODES: frozenset[str]
registry: Incomplete
lookup: Incomplete
